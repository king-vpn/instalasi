...
botbckpBot_menu() {
    ...
    if [ "${switch}" == "on" ]; then
        ...
        sts="\033[0;32m[Off]\033[0m"
    fi
	echo -e " ${BlueCyan}╭═══════════════════════════════════════════════════════╮${NC}"
	echo -e " ${BlueCyan}│$NC\033[41m               Telegram Bot (AutoBackup)               \E[0m"
	echo -e " ${BlueCyan}╰═══════════════════════════════════════════════════════╯${NC}"
    echo -e " ${BlueCyan}╭═══════════════════════════════════════════════════════╮${NC}"
    echo -e " ${BlueCyan}│$NC ${green} Status AutoBackup : $sts"
    echo -e " ${BlueCyan}│$NC [${green}1${NC}] Setup Bot Telegram \e[0m"
    echo -e " ${BlueCyan}│$NC [${green}2${NC}] Auto Backup Status \e[0m"
    echo -e " ${BlueCyan}│$NC [${green}3${NC}] Backup VPS (Telegram Bot) \e[0m"
    echo -e " ${BlueCyan}│$NC [${green}4${NC}] Restore Data \e[0m"
    echo -e " ${BlueCyan}│$NC [${green}5${NC}] Back To Main Menu \e[0m"
    echo -e " ${BlueCyan}╰═══════════════════════════════════════════════════════╯${NC}"
    echo -e ""
